          ...
          <div className="p-3 md:p-4 flex flex-col items-center">
            ...
            <div className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 rounded-xl p-2.5 md:p-3 flex flex-col items-center mb-3 group hover:border-blue-200 dark:hover:border-blue-500/50 transition-colors">
              ...
              <div className="flex items-center gap-2">
                 ...
                 <a href="tel:18887918007" className="text-lg md:text-xl font-black text-blue-900 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 transition-colors whitespace-nowrap">1888 791 8007</a>
              </div>
            </div>

            <div className="grid grid-cols-1 gap-2 w-full">
              <button className="bg-orange-500 hover:bg-orange-600 text-white text-xs md:text-sm font-bold py-2.5 rounded-xl shadow-xl shadow-orange-100 dark:shadow-none transition-all active:scale-95 flex items-center justify-center gap-2">
