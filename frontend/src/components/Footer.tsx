...
const Footer: React.FC<FooterProps> = ({ 
  ...
  return (
    <footer className={`${bgClass} dark:bg-slate-950 text-slate-400 py-12 md:py-20 border-t border-slate-800 dark:border-slate-900 transition-colors duration-300`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              />
              <span className="text-2xl font-bold tracking-tight text-white ml-1">Tour Help Desk</span>
            </div>
            <p className="text-sm leading-relaxed mb-6 dark:text-slate-500">
              Leading the sky with innovation, luxury, and unmatched safety standards. Your journey starts with us.
            </p>
            <div className="flex gap-4">
              <a href="https://www.facebook.com/tourhelpdesk.us" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-8 h-8 rounded-full bg-slate-800 dark:bg-slate-900 flex items-center justify-center hover:bg-[#1877F2] transition-colors text-white">
              ...
              <a href="https://www.instagram.com/tourhelpdesk/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 rounded-full bg-slate-800 dark:bg-slate-900 flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-500 hover:via-pink-500 hover:to-purple-600 transition-all text-white">
              ...
              <a href="https://www.youtube.com/@tour_help_desk" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-8 h-8 rounded-full bg-slate-800 dark:bg-slate-900 flex items-center justify-center hover:bg-[#FF0000] transition-colors text-white">
          ...
          <div>
            ...
            <p className="text-sm mb-4 dark:text-slate-500">Subscribe for exclusive travel deals.</p>
            <div className="flex gap-2">
              <input type="email" placeholder="Email address" className="bg-slate-800 dark:bg-slate-900 border-none rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-600 w-full" />
